...
#Alissa
manager = User.create([{username: "alissa.taylor", first_name: "alissa", last_name: "taylor"}])
...
employee.each do |e|
  ...
  e.update(first_name: first_name_, last_name: last_name_, manager: manager.first)
end

#Adam
manager = User.create([{username: "adam.thomas", first_name: "adam", last_name: "thomas"}])
employee = User.create([
...
#Perry
manager = User.create([{username: "perry.thomas", first_name: "perry", last_name: "thomas"}])
employee = User.create([
