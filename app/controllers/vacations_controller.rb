class VacationsController < ApplicationController
  ...
  def vacation_params
     ...
     all_params = params[which_params].require(:vacation).permit(:date_requested,:start_date,:end_date,:vacation_type,:business_days,:employee_id,:half_day,:reason,:status)
