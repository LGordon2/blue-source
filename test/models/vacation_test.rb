...
class VacationTest < ActiveSupport::TestCase
  ...
  test 'pdo type must be other if contractor' do
    v1 = Vacation.create(date_requested: '2014-05-19', start_date: '2014-04-17', end_date: '2014-05-22', vacation_type: 'Vacation', employee: employees(:contractor), manager: employees(:manager))
    assert v1.save
    assert_equal v1.vacation_type, 'Other'
  end

  test 'if pdo is other it must have a reason' do
    v1 = Vacation.create(date_requested: '2014-05-19', start_date: '2014-04-17', end_date: '2014-05-22', vacation_type: 'Other', employee: employees(:consultant), manager: employees(:manager))
    assert_not v1.save
  end

  test 'inactive employee cannot add pdo' do
    v1 = Vacation.create(date_requested: '2014-05-19', start_date: '2014-05-17', end_date: '2014-05-22', vacation_type: 'Vacation', employee: employees(:inactive), manager: employees(:manager))
    assert_not v1.save
  end
end
